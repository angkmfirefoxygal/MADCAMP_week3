...
class WebviewBridgeInterface3(private val mContext: Context, private val textView: TextView) {
...
class MyWebChromeClient3(private val mContext: AppCompatActivity) : WebChromeClient() {
 ...
 * - */
class LungeTracker : AppCompatActivity(){
    ...
    var exercise : String = "face_lunge"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.fragment_lunge)
        ...
        webView.addJavascriptInterface(WebviewBridgeInterface3(this, textApiResults), "Android")
        ...
        webView.setWebChromeClient(MyWebChromeClient3(this))
