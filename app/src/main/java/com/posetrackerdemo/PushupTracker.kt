...
class WebviewBridgeInterface1(private val mContext: Context, private val textView: TextView) {
...
class MyWebChromeClient1(private val mContext: AppCompatActivity) : WebChromeClient() {
 ...
 * - */
class PushupTracker : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.fragment_pushup)
        ...
        webView.addJavascriptInterface(WebviewBridgeInterface1(this, textApiResults), "Android")
        ...
        webView.setWebChromeClient(MyWebChromeClient1(this))
